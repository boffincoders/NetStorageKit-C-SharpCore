...
namespace Akamai.Utils
{
    ...
    public static class ExtensionMethods
    {
        ...
        public static byte[] ComputeKeyedHash(this byte[] data, string key, KeyedHashAlgorithm hashType = KeyedHashAlgorithm.HMACSHA256)
        {
            ...
            return HmacSHA256(data, key.ToByteArray());
        }
        ...
        public static string ConvertToQueryString(this object obj, Func<string, string> nameFormatter = null, Func<object, string> valueFormatter = null) 
        {
            if (obj == null) throw new ArgumentNullException("obj parameter cannot be null");

            Func<string, string> formatName = nameFormatter ?? delegate (string s) { return s; };
            Func<object, string> formatValue = valueFormatter ?? delegate(object o) { return o.ToString(); };
